...
Additional to simobserve, there are alternative tools to obtain the visibilities from a model image. For example, the package \texttt{galario} [@Tazzari:2018]

github citation [e.g., @Olberg:2021]
